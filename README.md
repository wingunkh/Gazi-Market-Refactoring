...
- 기존 중고 거래 플랫폼보다 신뢰할 수 있는 중고 스마트폰 거래 앱을 개발하는 것을 목적으로 한 프로젝트입니다.
- 이를 위해 스마트폰 상태 등급에 따른 시세를 제공하고, EXIF 메타데이터를 활용하여 상품 사진이 직접 촬영된 사진인지 다운로드된 사진인지 판별하는 기능을 제공합니다.
- 이외에도, 딥러닝을 활용한 스마트폰 기종 자동 분류, Kakao Map API를 활용한 위치 기반 서비스, 웹 소켓을 활용한 채팅 등 다양한 편의 기능을 제공합니다.
<br>
